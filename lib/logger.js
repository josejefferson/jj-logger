...
exports.getLogs = exports.syncPendingLogs = exports.logToLogger = exports.save = exports.load = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [4 /*yield*/, this.loadFn()];
                case 3:
                    logs = _a.sent();
                    this.logs = logs;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, this.saveFn(log)];
                case 1:
                    _a.sent();
 ...
 */
function logToLogger(opts, contents) {
    return __awaiter(this, void 0, void 0, function () {
        var err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.logToLogger = logToLogger;
/**
...
function syncPendingLogs() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            this.pendingLogs = [];
            promises = pendingLogs.map(this.logToLogger.bind(this));
            return [2 /*return*/, Promise.all(promises)];
        });
    });
}
exports.syncPendingLogs = syncPendingLogs;
/**
 * Returns the Log array
 * @param fetch Force the fetch of the database logs
 * @returns Log array
 */
function getLogs(fetch) {
