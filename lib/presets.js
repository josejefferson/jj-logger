...
exports.setOnFn = exports.add = exports.defaultPresets = void 0;
...
var LOGGER = false;
var NO_LOGGER = true;
var defaultPresets = function () { return ([
    [
        'success',
...
function setOnFn(log, Logger, opts) {
    ...
    var _loop_1 = function (preset) {
        ...
        log[presetName] = function () {
            ...
            return Logger.bind(_this).apply(void 0, presetFunction(opts, content).params).apply(void 0, (presetFunction(opts, content).content || content));
        };
    };
